...
async function main() {
  ...
  // Clear existing data
  await prisma.adminReferral.deleteMany()
  await prisma.cardNode.deleteMany()
  await prisma.cardTree.deleteMany()
  ...
  const chaseSapphirePreferred = await prisma.card.create({
    data: {
      ...
      annualFee: 95,
      rewardType: 'UR',
      tags: JSON.stringify(['travel', 'dining', 'ur-transfer', 'beginner-friendly']),
      isActive: true,
    },
  })
  ...
  const chaseSapphireReserve = await prisma.card.create({
    data: {
      ...
      annualFee: 550,
      rewardType: 'UR',
      tags: JSON.stringify(['travel', 'dining', 'ur-transfer', 'premium', 'lounge-access']),
      isActive: true,
    },
  })
  ...
  const chaseFreedomUnlimited = await prisma.card.create({
    data: {
      ...
      annualFee: 0,
      rewardType: 'UR',
      tags: JSON.stringify(['cashback', 'no-annual-fee', 'beginner-friendly']),
      isActive: true,
    },
  })
  ...
  const chaseFreedomFlex = await prisma.card.create({
    data: {
      ...
      annualFee: 0,
      rewardType: 'UR',
      tags: JSON.stringify(['cashback', 'no-annual-fee', 'rotating-categories']),
      isActive: true,
    },
  })
  ...
  const chaseInkBusinessPreferred = await prisma.card.create({
    data: {
      ...
      annualFee: 95,
      rewardType: 'UR',
      tags: JSON.stringify(['business', 'ur-transfer', 'travel']),
      isActive: true,
    },
  })
  ...
  const amexPlatinum = await prisma.card.create({
    data: {
      ...
      annualFee: 695,
      rewardType: 'MR',
      tags: JSON.stringify(['travel', 'mr-transfer', 'premium', 'lounge-access']),
      isActive: true,
    },
  })
  ...
  const amexGold = await prisma.card.create({
    data: {
      ...
      annualFee: 325,
      rewardType: 'MR',
      tags: JSON.stringify(['dining', 'groceries', 'mr-transfer']),
      isActive: true,
    },
  })
  ...
  const citiCustomCash = await prisma.card.create({
    data: {
      ...
      annualFee: 0,
      rewardType: 'cashback',
      tags: JSON.stringify(['cashback', 'no-annual-fee', 'automatic-categories']),
      isActive: true,
    },
  })
  ...
  const capitalOneVenture = await prisma.card.create({
    data: {
      ...
      annualFee: 95,
      rewardType: 'miles',
      tags: JSON.stringify(['travel', 'simple-redemption']),
      isActive: true,
    },
  })
  ...
  const capitalOneVentureX = await prisma.card.create({
    data: {
      ...
      annualFee: 395,
      rewardType: 'miles',
      tags: JSON.stringify(['travel', 'premium', 'lounge-access']),
      isActive: true,
    },
  })
  ...
  const capitalOneSavorOne = await prisma.card.create({
    data: {
      ...
      annualFee: 0,
      rewardType: 'cashback',
      tags: JSON.stringify(['cashback', 'dining', 'entertainment', 'no-annual-fee']),
      isActive: true,
    },
  })
  ...
  console.log(`✅ Created ${await prisma.adminReferral.count()} admin referrals`)
